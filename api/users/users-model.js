...
function findBy(filter) {
  return db("users as u").join("roles as r","u.role_id","r.role_id").where(filter).select("user_id","username","password","role_name")
  /**
    You will need to join two tables.
...
function findById(user_id) {
  return db("users as u").join("roles as r","u.role_id","r.role_id").where("u.user_id",user_id).select("user_id","username","role_name")
  /**
    You will need to join two tables.
